...
function get20s(array) {
  ...
  const strArray = array[i]['years'].split(' - ')
  if(strArray[0] >= 1900 && strArray[1] < 2000)
...
function addArtist(artists) {
  artists.push( 
    ...
    "genre": "Web Design", 
    "nationality": "Your Nationality Here",
    "bio": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore laborum in reprehenderit vel quia. Sequi corporis vitae in iure, doloribus ad velit illum, itaque voluptatibus eius provident molestias inventore? Molestiae."`
  )
  return artists
}
...
function lotsOfArt(artists, i) {
  let numPaintings = [];
  for(let i = 0; i < artists.length; i++){
  if(artists[i].paintings > 100)
  numPaintings.push(artists[i].name);
  }
  return numPaintings;
}
